            ...
            <CardContent className='space-y-6'>
              ...
              <div className='space-y-6'>
                ...
                <div className='space-y-2'>
                  <Label className='font-barlow font-bold uppercase tracking-widest text-gold'>
                  ...
                  <Dialog onOpenChange={setDialogIsOpen} open={dialogIsOpen}>
                    ...
                    <DialogContent className="bg-black border-gold">
                      <DialogHeader>
                        <DialogTitle className="text-gold">Horários da clinica</DialogTitle>
                        <DialogDescription className="text-zinc-500 uppercase tracking-widest text-xs font-bold">
